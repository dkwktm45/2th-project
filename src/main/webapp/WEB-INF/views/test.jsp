                  ...
                  $.ajax({
                   ...
                   success : function(result){
                      ...
                      $.each(result,(index,obj)=>{
                         ...
                         //html1+="<div class='set1'>"+(obj.user_set-2)+"set</div><div class='set2'>"+obj.user_set+"set</div>";
                         //html1+="<div class='set1'>"+(obj.user_set-1)+"set</div><div class='set2'>"+obj.user_set+"set</div>";
                         //html1+="<div class='set1'>"+(obj.user_set-0)+"set</div><div class='set2'>"+obj.user_set+"set</div>";
                         
                         //html1+="<br>"+obj.ex_count+"reps<br>"+obj.ex_count+"reps</div>";
                         //html1+="<div class='reps2'>"+obj.ex_count+"reps<br>"+obj.ex_count+"reps";
                         //html1+="<br>"+obj.ex_count+"reps<br>"+obj.ex_count+"reps</div>";
                         html1+="</div>";
                         html1+="</div>";
